...
public class VoidMethodPractice3 {
    public static void main(String[] args) {
        ...
        eligibleToVote("Lee", "Japan", 35 , true);
    ...
    public static void eligibleToVote(String name, String cicizenShip, int age, boolean isAlive) {
        if (cicizenShip.equalsIgnoreCase("USA")) {
